...
namespace TsarevZadohinDemoCofe.AppData
{
    class MessageBoxHelper
    {
        ...
        /// <summary>
        ///  Функция отображает сообщение для информации
        /// </summary>
        ...
        /// <summary>
        ///  Функция отображает изображения
        /// </summary>
        /// <param name="text">Текст предупреждения</param>
        /// <param name="title">Заголовок предупреждения</param>
        public static void Warning(string text, string title = "Информация")
        {
